...
namespace SDK.UI.Style.WXGA.Sparc
{
    ...
    static public class Buttons
    {
        public class ButtonPanel
        {
            ...
            private readonly char[] mLeftHotkeys = new[] { '1', '2', '3', '4', '5' };
            private readonly char[] mDownHotkeys = new[] { 'Q', 'W', 'E', 'R', 'T', 'Y', 'U', 'I' };
            private readonly char[] mRightHotkeys = new[] { 'A', 'S', 'D', 'F', 'G' };


            const int kButtonBiasY = 132;
            const int kButtonBiasX = 148;

            private const int kButtonSideY = 635;
        ...
        public static Button SideButton(IWidget parent, string text, int x, int y, ColorStyle style = ColorStyle.Default)
        {
            ...
            var contour = new VGPath(mClassicOutline, new VGSolidColor(new Color(0x00AEEFFF)), mClassicActiveVGPaintDefault) { StrokeWidth = 3.0f };
        ...
        public static Button DownButton(IWidget parent, string text, int x, int y, ColorStyle style = ColorStyle.Default)
        {
            ...
            var contour = new VGPath(mDownOutline, new VGSolidColor(new Color(0x00AEEFFF)), mClassicActiveVGPaintDefault) { StrokeWidth = 3.0f };
