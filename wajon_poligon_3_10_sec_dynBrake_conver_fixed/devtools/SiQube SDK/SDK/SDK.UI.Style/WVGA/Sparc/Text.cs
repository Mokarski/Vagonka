...
namespace SDK.UI.Style.WVGA.Sparc
{
    ...
    public static class Text
    {
        ...
        public static TextArea[] Label(IWidget parent, string text, int size, int x, int y, int width = 480, int lineHeight = 30, Align align = Align.Center, Color color = null)
        {
            ...
            for (var i = 0; i < lines.Length; i++)
            {
                ...
                line.SetFont(color ?? Palette.White, size);
