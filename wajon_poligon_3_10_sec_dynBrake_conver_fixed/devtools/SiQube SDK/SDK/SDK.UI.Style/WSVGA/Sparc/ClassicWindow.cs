...
namespace SDK.UI.Style.WSVGA.Sparc
{
    public class ClassicWindow : Window
    {
        ...
        protected void InitPanel()
        {
            ...
            var sparc = new Image(this, 10, 570);
            var polimermash = new Image(this, 120, 570);


            sparc.Scale(0.9f, 0.9f);
            polimermash.Scale(0.7f, 0.7f);

            Text.Label(this, "Система управления температурой нагревательных плит", 30, 275, 565, Application.Screen.Width, 30, Align.Left);

            OnShow += caller =>
            {
                sparc.Load("logo_sparc.raw");
                polimermash.Load("logo_polimermash.raw");
            };
        }
