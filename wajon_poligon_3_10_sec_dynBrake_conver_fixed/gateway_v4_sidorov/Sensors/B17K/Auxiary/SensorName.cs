namespace Sensors.B17K
{
    ...
    public enum SignalName
    {
        ...
        PcProcVer,
        Panel43Ver,
        //Системные параметры Детектор модуля Wago 493 
        ComNumber,
        ComSpeed,
        Detect493,
        Convmode,
        ...
        Hour,
        Minutes,   
        //Входы в меню сервисанта и инжинера
        ServiceEnter,
        EngineerEnter,
        //МотоЧасы КиловаттЧасы
        MotoHours,
        KWHours,
        // Замена масла
        OilRefresh,
    ...
    public enum SigпalOil
    {
        OilRefresh
    }

    public enum SigпalWorkHours
    {
        MotoHours,
        KWHours
    }
    public enum SigпalEnterMenu
    {
        PcProc,
        Panel43
    }
    ...
    public class SensorName
    {
        ...
        public static string OilHour(SignalName sensor)
        {
            const string kParent = "local.OilHours";
            return string.Format("{0}", kParent, sensor).ToLower();
        }
