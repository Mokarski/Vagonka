...
#pscp "patch_gw_v1\journals.db" root@192.168.1.121:/mnt/software/bin
...
#pscp "patch_gw_v1\signals.db" root@192.168.1.121:/mnt/software/bin
...
pscp "patch_gw_v1\SDK.Watchdog.exe" root@192.168.1.121:/mnt/software/bin
