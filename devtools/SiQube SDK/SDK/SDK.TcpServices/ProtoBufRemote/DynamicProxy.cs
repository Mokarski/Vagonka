    ...
    internal class DynamicProxy : DynamicObject
    {
        ...
        public override bool TryInvokeMember(InvokeMemberBinder binder, object[] args, out object result)
        {
            if (binder.Name.StartsWith("Begin") && args.Length >= 2)
            {
                ...
                //an async call
                var callbackArg = args[args.Length-2];
                var callback = callbackArg as AsyncCallback;
                if (callbackArg == null || callback != null)
                {
                    ...
                    result = mClient.Call(mServiceName, methodName, newArgs, callback, state);
                    return true;
                }
            }
            ...
            if (binder.Name.StartsWith("End") && args.Length == 1 && args[0] is IAsyncResult)
                ...
                pendingCall = mClient.Call(mServiceName, binder.Name, args, null, null);
            ...
            if (pendingCall.IsFailed)
                throw new InvalidRpcCallException(mServiceName, binder.Name,
