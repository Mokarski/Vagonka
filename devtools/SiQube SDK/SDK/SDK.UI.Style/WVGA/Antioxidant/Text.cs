...
namespace SDK.UI.Style.WVGA.Antioxidant
{
    ...
    public static class Text
    {
        ...
        public static void Label(IWidget parent, string text, int size, int x, int y, int width = 480, int lineHeight = 30, Align align = Align.Center)
        {
            ...
            for (var i = 0; i < lines.Length; i++)
            {
                ...
                line.SetFont(Palette.White, size);
            }
        }
