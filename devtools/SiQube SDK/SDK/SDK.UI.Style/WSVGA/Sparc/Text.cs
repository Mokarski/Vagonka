...
namespace SDK.UI.Style.WSVGA.Sparc
{
    ...
    public static class Text
    {
        ...
        public static void Label(IWidget parent, string text, int size, int x, int y, int width = 1280, int lineHeight = 30, Align align = Align.Center)
        {
            ...
            for (var i = 0; i < lines.Length; i++)
            {
                ...
                line.SetFont(new Color(0xD1D3D4FF), size);
            }
        }
        ...
        {
            var rv = new TextArea(parent, Application.Screen.Width - 80, 567, Application.Screen.Width, 35) { Text = System.DateTime.Now.ToString("HH:mm") };
            rv.SetAlign(Align.Left);
            rv.SetFont(new Color(0xD1D3D4FF), 30);
