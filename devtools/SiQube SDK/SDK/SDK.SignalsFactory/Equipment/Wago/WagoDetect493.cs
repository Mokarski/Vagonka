    ...
    public class WagoDetect493
    {
        static public void Add(Coupler coupler, ushort register, IList<ISignal> signals)
        {
            ...
            var output = new List<Signal>
                             {                                
                                new Signal(string.Format("wago493.internal.1.{0}", register)),
                                new Signal(string.Format("wago493.internal.2.{0}", register)),
                                new Signal(string.Format("wago493.internal.3.{0}", register))
                             };
